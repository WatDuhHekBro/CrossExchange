...
enum PermissionsEnum {NONE, MOD, ADMIN, OWNER, BOT_SUPPORT, BOT_ADMIN, BOT_OWNER}
...
// In order to make this work, it has to be a module (import/export something) and be loaded into the actual code (execute this function so that the compiler's dead code elimination doesn't discard this import.)
